package com.quinsoft.zeidon.jasperreports.test;
...
import com.quinsoft.zeidon.jasperreports.JRViewDataSource;
import com.quinsoft.zeidon.standardoe.JavaObjectEngine;
import com.quinsoft.zeidon.utils.JoeUtils;
import com.quinsoft.zeidon.utils.ZeidonInputStream;


public class ViewDataSourceApp extends AbstractSampleApp
{
	...
	{
		main(new ViewDataSourceApp(), args);
	}
...
//        oe.startBrowser();
        ...
        View stud = zencas.deserializeOi()
                          .fromZeidonHomeFile( "ZENCAs/mStudenCOI.por" )
                          .setLodDef( "mStudenC" )
                          .activateFirst();
...
//		JasperFillManager.fillReportToFile("target/classes/JsonCustomersReport.jasper", params);
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.printReport("target/classes/JsonCustomersReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToPdfFile("target/classes/JsonCustomersReport.jrprint");
