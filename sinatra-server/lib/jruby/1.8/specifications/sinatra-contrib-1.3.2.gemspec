...
Gem::Specification.new do |s|
  ...
  s.authors = ["Konstantin Haase", "Gabriel Andretta", "Trevor Bramble", "Nicolas Sanguinetti", "Ilya Shindyapin", "Masahiro Fujiwara", "Adrian Paca\305\202a", "Andrew Crump", "Eliot Shepard", "Eric Marden", "Gray Manley", "Matt Lyon", "lest", "undr"]
  s.date = "2012-10-22"
