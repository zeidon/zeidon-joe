               ...
               MutableDouble  dLongitude )
{
   ...
   o_fnLocalBuildQual_0( zAny, vTempViewVar_0, szZipCode );
   RESULT = ActivateObjectInstance( sZipFind, "sZipFind", zAny, vTempViewVar_0, zSINGLE );
   DropView( vTempViewVar_0 );
   //:IF RESULT < 0
   if ( RESULT < 0 )
   { 
      ...
      o_fnLocalBuildQual_1( zAny, vTempViewVar_1, szZipCode4 );
      RESULT = ActivateObjectInstance( sZipFind, "sZipFind", zAny, vTempViewVar_1, zMULTIPLE );
      DropView( vTempViewVar_1 );
      ...
      RESULT = SetCursorLastEntity( sZipFind, "ZipCodeLookUpTable", "" );
      if ( RESULT > zCURSOR_UNCHANGED )
      { 
         while ( RESULT > zCURSOR_UNCHANGED && ( CompareAttributeToString( sZipFind, "ZipCodeLookUpTable", "ZipCode", szZipCode ) >= 0 ) )
         { 
            RESULT = SetCursorPrevEntity( sZipFind, "ZipCodeLookUpTable", "" );
         } 

      } 

      //:IF sZipFind.ZipCodeLookUpTable EXISTS
      lTempInteger_0 = CheckExistenceOfEntity( sZipFind, "ZipCodeLookUpTable" );
      if ( lTempInteger_0 == 0 )
      { 
         //:RESULT = 0
         RESULT = 0;
   ...
   { 
      ...
      GetDecimalFromAttribute( dLatitude, sZipFind, "ZipCodeLookUpTable", "Latitude" );
      //:dLongitude = sZipFind.ZipCodeLookUpTable.Longitude
      GetDecimalFromAttribute( dLongitude, sZipFind, "ZipCodeLookUpTable", "Longitude" );
   } 
