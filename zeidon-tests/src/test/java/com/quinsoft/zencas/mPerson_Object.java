   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         { 
            ...
            lTempInteger_0 = CheckExistenceOfEntity( mPerson, "AdministrativeDivision" );
            if ( lTempInteger_0 == 0 )
            { 
         ...
         lTempInteger_1 = CheckExistenceOfEntity( mPerson, "Faculty" );
         if ( lTempInteger_1 == 0 )
         { 
         ...
         lTempInteger_3 = CheckExistenceOfEntity( mPerson, "Donor" );
         if ( lTempInteger_3 == 0 )
         { 
            //:szType = szType + "Donor, "
             {StringBuilder sb_szType;
         ...
         lTempInteger_4 = CheckExistenceOfEntity( mPerson, "Student" );
         if ( lTempInteger_4 == 0 )
         { 
            ...
            if ( szTempString_0 == null )
               ...
               sb_szTempString_0 = new StringBuilder( szTempString_0 );
                         GetVariableFromAttribute( sb_szTempString_0, mi_lTempInteger_5, 'S', 6, mPerson, "StudentAdministrativeDivision", "NamePrefix", "", 0 );
         ...
         lTempInteger_6 = CheckExistenceOfEntity( mPerson, "Alumni" );
         if ( lTempInteger_6 == 0 )
         { 
         ...
         lTempInteger_7 = CheckExistenceOfEntity( mPerson, "Employee" );
         if ( lTempInteger_7 == 0 )
         { 
         ...
         lTempInteger_8 = CheckExistenceOfEntity( mPerson, "FinAidProfile" );
         if ( lTempInteger_8 == 0 )
         { 
         ...
         lTempInteger_9 = CheckExistenceOfEntity( mPerson, "Vendor" );
         if ( lTempInteger_9 == 0 )
         { 
   ...
   { 
      ...
      case zOCE_ACTIVATE :
         ...
         { 
            ...
            {MutableInt mi_lTempInteger_1 = new MutableInt( lTempInteger_1 );
                         GetIntegerFromAttribute( mi_lTempInteger_1, mPerson2, "PrimaryAddress", "ID" );
            lTempInteger_1 = mi_lTempInteger_1.intValue( );}
            RESULT = SetCursorFirstEntityByInteger( mPerson2, "Address", "ID", lTempInteger_1, "" );
            ...
            lTempInteger_2 = CheckExistenceOfEntity( mPerson2, "PrimaryForPerson" );
            if ( lTempInteger_2 == 0 )
            { 
               //: RelinkInstanceToInstance( mPerson2, "PrimaryForPerson",
               //:                           mPerson2, "Person" )
               RelinkInstanceToInstance( mPerson2, "PrimaryForPerson", mPerson2, "Person" );
            } 
               ...
               { 
                  ...
                  { 
                     ...
                     { 
                        ...
                        if ( ZeidonStringCompare( szFunctionalArea, 1, 0, "FinancialAid", 1, 0, 33 ) == 0 || ZeidonStringCompare( szFunctionalArea, 1, 0, "StudentAccounts", 1, 0, 33 ) == 0 )
                        { 
                           //: IF mStudent.ContactActivity.FunctionalArea = "FinancialAid" OR 
                           //:    mStudent.ContactActivity.FunctionalArea = "StudentAccounts"
                           if ( CompareAttributeToString( mStudent, "ContactActivity", "FunctionalArea", "FinancialAid" ) == 0 || CompareAttributeToString( mStudent, "ContactActivity", "FunctionalArea", "StudentAccounts" ) == 0 )
                           { 
                              //: 
      ...
      case zOCE_COMMIT :
         ...
         { 
            ...
            {
             ZGLOBAL2_Operation m_ZGLOBAL2_Operation = new ZGLOBAL2_Operation( mPerson );
             m_ZGLOBAL2_Operation.SetIPEDS_Ethnicity( mPerson );
             // m_ZGLOBAL2_Operation = null;  // permit gc  (unnecessary)
            }

            //:// If the Person is Deceased, make sure the ContactPreference attribute is set to "do not call" (N).
            //:IF mPerson.Person.Deceased = "Y"
            if ( CompareAttributeToString( mPerson, "Person", "Deceased", "Y" ) == 0 )
            { 
               //:mPerson.Person.ContactPreference = "N"
               SetAttributeFromString( mPerson, "Person", "ContactPreference", "N" );
            } 
            ...
            //:IF mPerson.Prospect EXISTS
            lTempInteger_11 = CheckExistenceOfEntity( mPerson, "Prospect" );
                                 ...
                                 Integer   State )
{
   ...
   { 
      ...
      case zECE_ACCEPT :
         ...
         //:// If an Address has a Canadian Province specified, set the Country to Canada if it's currently null.
         //:IF mPerson.Address EXISTS
         lTempInteger_2 = CheckExistenceOfEntity( mPerson, "Address" );
         if ( lTempInteger_2 == 0 )
         { 
            //:IF mPerson.Address.Country = "" AND 
            //:( mPerson.Address.StateProvince = "AB" OR
            //:mPerson.Address.StateProvince = "BC" OR
            //:mPerson.Address.StateProvince = "MB" OR
            //:mPerson.Address.StateProvince = "NB" OR
            //:mPerson.Address.StateProvince = "NF" OR
            //:mPerson.Address.StateProvince = "NS" OR
            //:mPerson.Address.StateProvince = "NT" OR
            //:mPerson.Address.StateProvince = "ON" OR
            //:mPerson.Address.StateProvince = "PE" OR
            //:mPerson.Address.StateProvince = "QC" OR
            //:mPerson.Address.StateProvince = "SK" OR
            //:mPerson.Address.StateProvince = "YK" )
            if ( CompareAttributeToString( mPerson, "Address", "Country", "" ) == 0 && ( CompareAttributeToString( mPerson, "Address", "StateProvince", "AB" ) == 0 || CompareAttributeToString( mPerson, "Address", "StateProvince", "BC" ) == 0 ||
                 CompareAttributeToString( mPerson, "Address", "StateProvince", "MB" ) == 0 || CompareAttributeToString( mPerson, "Address", "StateProvince", "NB" ) == 0 || CompareAttributeToString( mPerson, "Address", "StateProvince", "NF" ) == 0 ||
                 CompareAttributeToString( mPerson, "Address", "StateProvince", "NS" ) == 0 || CompareAttributeToString( mPerson, "Address", "StateProvince", "NT" ) == 0 || CompareAttributeToString( mPerson, "Address", "StateProvince", "ON" ) == 0 ||
                 CompareAttributeToString( mPerson, "Address", "StateProvince", "PE" ) == 0 || CompareAttributeToString( mPerson, "Address", "StateProvince", "QC" ) == 0 || CompareAttributeToString( mPerson, "Address", "StateProvince", "SK" ) == 0 ||
                 CompareAttributeToString( mPerson, "Address", "StateProvince", "YK" ) == 0 ) )
            { 

               //:mPerson.Address.Country = "Canada"
               SetAttributeFromString( mPerson, "Address", "Country", "Canada" );
            } 
...
//:DERIVED ATTRIBUTE OPERATION
public int 
omPerson_dDeceasedDisplayText( View     mPerson,
                               String InternalEntityStructure,
                               String InternalAttribStructure,
                               Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         if ( CompareAttributeToString( mPerson, "FamilyPerson", "Deceased", "Y" ) == 0 )
         { 
            //:StoreStringInRecord ( mPerson,
            //:                      InternalEntityStructure, InternalAttribStructure, "Deceased" )
            StoreStringInRecord( mPerson, InternalEntityStructure, InternalAttribStructure, "Deceased" );
            //:ELSE 
         } 
         else
         { 
...
public int 
omPerson_dListedCA_DocumentName( View     mPerson,
                                 String InternalEntityStructure,
                                 String InternalAttribStructure,
                                 Integer   GetOrSetFlag )
{
   String   szDocumentName = null;
   int      lTempInteger_0 = 0;
   int      lTempInteger_1 = 0;
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         if ( CompareAttributeToString( mPerson, "ListedContactActivity", "HealthServicesNote", "" ) == 0 )
         { 
            //:// This is a regular contact activity entry, so use Document Name, if it exists.
            //:IF mPerson.ListedContactActivityDocument EXISTS
            lTempInteger_0 = CheckExistenceOfEntity( mPerson, "ListedContactActivityDocument" );
            if ( lTempInteger_0 == 0 )
            { 
               //:szDocumentName = mPerson.ListedContactActivityDocument.Name 
               {MutableInt mi_lTempInteger_1 = new MutableInt( lTempInteger_1 );
               StringBuilder sb_szDocumentName;
               if ( szDocumentName == null )
                  sb_szDocumentName = new StringBuilder( 32 );
               else
                  sb_szDocumentName = new StringBuilder( szDocumentName );
                               GetVariableFromAttribute( sb_szDocumentName, mi_lTempInteger_1, 'S', 91, mPerson, "ListedContactActivityDocument", "Name", "", 0 );
               lTempInteger_1 = mi_lTempInteger_1.intValue( );
               szDocumentName = sb_szDocumentName.toString( );}
            } 
         ...
         { 
            ...
            if ( szDocumentName == null )
               ...
               sb_szDocumentName = new StringBuilder( szDocumentName );
                        ZeidonStringCopy( sb_szDocumentName, 1, 0, "Health Services Note", 1, 0, 91 );
            szDocumentName = sb_szDocumentName.toString( );}
         } 
         ...
         StoreStringInRecord( mPerson, InternalEntityStructure, InternalAttribStructure, szDocumentName );
         break ;
      //:   
      //:  /* end zDERIVED_GET */
      //:OF   zDERIVED_SET:
