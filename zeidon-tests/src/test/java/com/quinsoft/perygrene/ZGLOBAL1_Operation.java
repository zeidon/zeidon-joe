...
/*
 // This is for creating an excel spread sheet.
...
public class ZGLOBAL1_Operation extends VmlOperation
{
    ...
    public int ActivateSysOI_FromFile( zVIEW view, String viewOdName, View qualView, String fileName, int control )
    {
       ...
       if ( qualView != null )
       {
           ...
           view = (zVIEW) task.deserializeOi()
                   .fromFile( fileName )
                   .setLodDef( viewOdName )
                   .activateFirst();
      }
    ...
    */
                             ...
                             String stringContext )
    {
       ...
       int     lLth;
    // String  string;
//         strComboCurrentValue = mStudent.cursor( "Student" ).getStringFromAttribute( "Status", "" );
 ...
 **/
                            ...
                            String stringFileName )
    {
       ...
       if ( nPosition >= 0 )  // if we found the last period ...
       {
          stringReturnedSuffix.append( stringFileName.substring( nPosition + 1 ).toLowerCase( ));
       }
       else
 ...
 **/
    ...
    AD_TestAdminNotFast( )
    {
		...
		// Try binding w/o fastbind.
   	    return -1; //m_ActiveDirectory.ActiveDirectoryLoginAuthenticationNF( ldapurl, "enc-ad\\zmail", "F82b7mk,9j" );
    ...
    AD_TestUserNotFast( )
    {
		...
		String szAD_Password = "";
		// Try binding w/o fastbind.
   	    return -1; //m_ActiveDirectory.ActiveDirectoryLoginAuthenticationNF( ldapurl, stringADUserName, szAD_Password );
    }
    ...
    AD_TestUser( )
    {
		...
		String szAD_Password = "";
		// This is using fastbind.
   	    return -1; //m_ActiveDirectory.ActiveDirectoryLoginAuthentication( ldapurl, stringADUserName, szAD_Password );
    }
                           ...
                           String stringAD_NewPassword )
    {
    	...
    	return 0;//m_ActiveDirectory.ActiveDirectoryChangePassword( stringAD_Pathname, stringAD_LoginUserName, stringAD_LoginPassword, stringAD_UserName, stringAD_OldPassword, stringAD_NewPassword );
    ...
    {
       return -1; //m_ActiveDirectory.ActiveDirectorySetPassword( stringAD_Pathname, stringAD_LoginUserName, stringAD_LoginPassword, stringAD_UserName, stringAD_Password, stringAD_Password );
    }
                        ...
                        String stringAD_PropertyValue )
    {
       ...
       nRC = -1; //m_ActiveDirectory.ActiveDirectorySetProperty( stringAD_Pathname, stringAD_AdminName, stringAD_AdminPassword, stringAD_UserName, stringAD_PropertyName, stringAD_PropertyValue );
       return nRC;
 ...
 */
	...
	public int RunScheduledQueries( View tempview, String queryInterval, String carrierCode )
	{
	    ...
	    zVIEW    wXferO = new zVIEW( );
	    zVIEW    mSumRptDef = new zVIEW( );
	    zVIEW    vQualObject = new zVIEW( );
	    int      RESULT = 0;
	    zVIEW    vTempViewVar_1 = new zVIEW( );
	    zVIEW    vTempViewVar_2 = new zVIEW( );

		RESULT = SfActivateSysEmptyOI( vQualObject, "KZDBHQUA", tempview, zMULTIPLE );
		CreateEntity( vQualObject, "EntitySpec", zPOS_AFTER );
		SetAttributeFromString( vQualObject, "EntitySpec", "EntityName", "SummaryReportDefinition" );
		CreateEntity( vQualObject, "QualAttrib", zPOS_AFTER );
