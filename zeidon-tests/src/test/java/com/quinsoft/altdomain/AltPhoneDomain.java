...
import com.quinsoft.zeidon.domains.PhoneDomain;
 ...
 *
 */
public class AltPhoneDomain extends PhoneDomain
{
    public AltPhoneDomain(Application application, Map<String, Object> domainProperties, Task task )
    {
    ...
    public int compare(Task task, AttributeInstance attributeInstance, AttributeDef attributeDef, Object internalValue, Object externalValue)
    {
    	...
    	catch ( Throwable t )
    	{
            ...
            {
 		       task.log().info("************* AltPhoneDomain Compare Ignoring ERROR *************************");
    		   return -1;
            }
            else
            {
