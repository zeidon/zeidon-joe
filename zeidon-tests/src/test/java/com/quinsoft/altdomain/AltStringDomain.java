 ...
 *
 */
public class AltStringDomain extends StringDomain
{
    public AltStringDomain(Application application, Map<String, Object> domainProperties, Task task )
    {
    ...
    public int compare(Task task, AttributeInstance attributeInstance, AttributeDef attributeDef, Object internalValue, Object externalValue)
    {
    	...
    	catch ( Throwable t )
    	{
            ...
            {
		       task.log().info("************* AltStringDomain Compare Ignoring ERROR *************************");
    		   return -1;
            }
            else
            {
