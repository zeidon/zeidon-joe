 ...
 *
 */
public class AltDynamicTableDomain extends DynamicTableDomain
{
    public AltDynamicTableDomain(Application application, Map<String, Object> domainProperties, Task task )
    {
