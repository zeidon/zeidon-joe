 ...
 *
 */
public class AltDoubleDomain extends DoubleDomain
{
    public AltDoubleDomain(Application application, Map<String, Object> domainProperties, Task task )
    {
    ...
    public int compare(Task task, AttributeInstance attributeInstance, AttributeDef attributeDef, Object internalValue, Object externalValue)
    {
    	Object value = null;
 		...
 		//task.log().info("******************** AltDoubleDomain Compare ********************************");
    	...
    	catch ( Throwable t )
    	{
            ...
            {
 		       task.log().info("************* AltDoubleDomain Compare Ignoring ERROR *************************");
    		   return -1;
            }
            else
            {
