 ...
 *
 */
public class AltIntegerDomain extends IntegerDomain
{
    public AltIntegerDomain(Application application, Map<String, Object> domainProperties, Task task )
    {
    ...
    public int compare(Task task, AttributeInstance attributeInstance, AttributeDef attributeDef, Object internalValue, Object externalValue)
    {
    	...
    	catch ( Throwable t )
    	{
            ...
            {
 		       task.log().info("************* AltIntegerDomain Compare Ignoring ERROR *************************");
    		   return -1;
            }
            else
            {
