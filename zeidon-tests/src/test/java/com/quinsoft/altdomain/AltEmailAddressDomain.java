...
import com.quinsoft.zeidon.domains.EmailAddressDomain;
 ...
 *
 */
public class AltEmailAddressDomain extends EmailAddressDomain
{
    public AltEmailAddressDomain(Application application, Map<String, Object> domainProperties, Task task )
    {
    ...
    public int compare(Task task, AttributeInstance attributeInstance, AttributeDef attributeDef, Object internalValue, Object externalValue)
    {
    	...
    	catch ( Throwable t )
    	{
            ...
            {
 		       task.log().info("************* AltEmailDomain Compare Ignoring ERROR *************************");
    		   return -1;
            }
            else
            {
