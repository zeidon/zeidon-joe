...
import com.quinsoft.zeidon.domains.SSNDomain;
 ...
 *
 */
public class AltSSNDomain extends SSNDomain
{
    public AltSSNDomain(Application application, Map<String, Object> domainProperties, Task task )
    {
