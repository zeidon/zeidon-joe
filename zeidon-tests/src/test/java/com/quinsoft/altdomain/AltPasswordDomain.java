...
import com.quinsoft.zeidon.domains.PasswordDomain;
 ...
 *
 */
public class AltPasswordDomain extends PasswordDomain
{
    public AltPasswordDomain(Application application, Map<String, Object> domainProperties, Task task )
    {
