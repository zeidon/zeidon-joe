...
AcceptNewSubregUser( View     ViewToWindow )
{
   ...
   { 
      ...
      lTempInteger_1 = SetEntityCursor( mSubreg, "User", "UserName", lControl, szUserName, "", "", 0, "", "" );
   ...
   //:ACTIVATE qSubreg WHERE qSubreg.SubregOrganization.LoginName = "Admin"
   o_fnLocalBuildQual_6( ViewToWindow, vTempViewVar_0 );
   RESULT = ActivateObjectInstance( qSubreg, "qSubreg", ViewToWindow, vTempViewVar_0, zSINGLE );
   DropView( vTempViewVar_0 );
   //:NAME VIEW qSubreg "qSubreg"
   SetNameForView( qSubreg, "qSubreg", null, zLEVEL_TASK );
   //:IF qSubreg.Subregistrant DOES NOT EXIST
   lTempInteger_2 = CheckExistenceOfEntity( qSubreg, "Subregistrant" );
   if ( lTempInteger_2 != 0 )
   { 
      //:// No subregistrant found!  The first login name must be "Admin".
      //:nRC = zstrcmpi( szUserName, "Admin" )
      nRC = zstrcmpi( szUserName, "Admin" );
      //:IF nRC != 0
      if ( nRC != 0 )
      { 
      ...
      { 
         ...
         if ( szUserName == null )
            ...
            sb_szUserName = new StringBuilder( szUserName );
                  ZeidonStringCopy( sb_szUserName, 1, 0, "Admin", 1, 0, 51 );
         szUserName = sb_szUserName.toString( );}
      } 
...
InitSubregLabelContentForInsert( View     ViewToWindow )
{
   ...
   { 
      ...
      lTempInteger_3 = mi_lTempInteger_3.intValue( );}
      o_fnLocalBuildQual_12( ViewToWindow, vTempViewVar_2, lTempInteger_3 );
   ...
   { 
      ...
      lTempInteger_5 = mi_lTempInteger_5.intValue( );}
      o_fnLocalBuildQual_13( ViewToWindow, vTempViewVar_3, lTempInteger_5 );
