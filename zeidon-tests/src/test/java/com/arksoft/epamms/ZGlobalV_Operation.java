                               ...
                               String   szComment )
{
   ...
   { 
      ...
      if ( ZeidonStringCompare( szEntityName, 1, 0, "SI_FirstAidSection", 1, 0, 33 ) == 0 || ZeidonStringCompare( szEntityName, 1, 0, "SI_PrecautionarySection", 1, 0, 33 ) == 0 ||
           ZeidonStringCompare( szEntityName, 1, 0, "SI_HazardSection", 1, 0, 33 ) == 0 || ZeidonStringCompare( szEntityName, 1, 0, "SI_UsageList", 1, 0, 33 ) == 0 )
      { 
         ...
         if ( ZeidonStringCompare( szEntitySection, 1, 0, "SI_UsageList", 1, 0, 33 ) == 0 )
         { 
            ...
            { 
               ...
               { 
                  ...
                  SetMatchingAttributesByName( mTempLC, "S_Usage", mTempLC, szEntitySection, zSET_NOTNULL );
                  ...
                  if ( szSelected == null )
                     ...
                     sb_szSelected = new StringBuilder( szSelected );
                                     GetStringFromAttribute( sb_szSelected, mTempLC, szEntitySection, "Selected" );
                  szSelected = sb_szSelected.toString( );}
                  //:mTempLC.S_Usage.Selected = szSelected
                  SetAttributeFromString( mTempLC, "S_Usage", "Selected", szSelected );
               } 
         ...
         { 
            ...
            if ( ZeidonStringCompare( szEntitySection, 1, 0, "SI_FirstAidSection", 1, 0, 33 ) == 0 )
            { 
               ...
               if ( szEntityStatement == null )
                  ...
                  sb_szEntityStatement = new StringBuilder( szEntityStatement );
                              ZeidonStringCopy( sb_szEntityStatement, 1, 0, "S_FirstAidStatement", 1, 0, 33 );
               szEntityStatement = sb_szEntityStatement.toString( );}
               //:ELSE
            } 
            else
            { 
               ...
               if ( ZeidonStringCompare( szEntitySection, 1, 0, "SI_PrecautionarySection", 1, 0, 33 ) == 0 )
               { 
                  ...
                  if ( szEntityStatement == null )
                     ...
                     sb_szEntityStatement = new StringBuilder( szEntityStatement );
                                    ZeidonStringCopy( sb_szEntityStatement, 1, 0, "S_PrecautionaryStatement", 1, 0, 33 );
                  szEntityStatement = sb_szEntityStatement.toString( );}
                  //:ELSE
               } 
               else
               { 
                  ...
                  if ( ZeidonStringCompare( szEntitySection, 1, 0, "SI_HazardSection", 1, 0, 33 ) == 0 )
                  { 
                     ...
                     if ( szEntityStatement == null )
                        ...
                        sb_szEntityStatement = new StringBuilder( szEntityStatement );
                                          ZeidonStringCopy( sb_szEntityStatement, 1, 0, "S_HazardStatement", 1, 0, 33 );
                     szEntityStatement = sb_szEntityStatement.toString( );}
                  } 
            ...
            { 
               ...
               {MutableInt mi_lID = new MutableInt( lID );
                               GetIntegerFromAttribute( mi_lID, mTempLC, szEntitySection, "ID" );
               lID = mi_lID.intValue( );}
               ...
               //:                             mTempLC, szEntitySection, zSET_NOTNULL )
               SetMatchingAttributesByName( mTempLC, "S_GeneralSection", mTempLC, szEntitySection, zSET_NOTNULL );
               ...
               { 
                  ...
                  {MutableInt mi_lID = new MutableInt( lID );
                                     GetIntegerFromAttribute( mi_lID, mTempLC, szEntityStatement, "ID" );
                  lID = mi_lID.intValue( );}
                  ...
                  { 
                     ...
                     SetMatchingAttributesByName( mTempLC, "S_GeneralStatement", mTempLC, szEntityStatement, zSET_NOTNULL );
                     ...
                     if ( szSelected == null )
                        ...
                        sb_szSelected = new StringBuilder( szSelected );
                                           GetStringFromAttribute( sb_szSelected, mTempLC, szEntityStatement, "Selected" );
                     szSelected = sb_szSelected.toString( );}
                     //:IF szSelected = ""
                     if ( ZeidonStringCompare( szSelected, 1, 0, "", 1, 0, 2 ) == 0 )
                     { 
                     ...
                     SetAttributeFromString( mTempLC, "S_GeneralStatement", "Selected", szSelected );
                     //:// TraceLineS( "After set matching ////////////////* selected: ", szSelected )
                     //:// DisplayEntityInstance( mTempLC, "S_GeneralStatement" )
                     //:// TraceLineS( "", "" )
                     //:ELSE
      ...
      { 
         ...
         MiSetInstanceUpdateFlag( mSubLC, TRUE );
         //:COMMIT mSubLC
         RESULT = CommitObjectInstance( mSubLC );
         //:szFullComment = "Accept/Commit"
          {StringBuilder sb_szFullComment;
      ...
      if ( szFullComment == null )
         ...
         sb_szFullComment = new StringBuilder( szFullComment );
            ZeidonStringConcat( sb_szFullComment, 1, 0, " mSubLC.", 1, 0, 301 );
      szFullComment = sb_szFullComment.toString( );}
       {StringBuilder sb_szFullComment;
      if ( szFullComment == null )
         sb_szFullComment = new StringBuilder( 32 );
   ...
   { 
      ...
      if ( szFullComment == null )
         ...
         sb_szFullComment = new StringBuilder( szFullComment );
            ZeidonStringCopy( sb_szFullComment, 1, 0, "Nothing to accept mSubLC.", 1, 0, 301 );
      szFullComment = sb_szFullComment.toString( );}
       {StringBuilder sb_szFullComment;
      if ( szFullComment == null )
         sb_szFullComment = new StringBuilder( 32 );
                                 ...
                                 String   szComment )
{
   ...
   if ( ZeidonStringCompare( szEntityName, 1, 0, "", 1, 0, 33 ) != 0 && getView( mTempl ) != null )
   { 
      ...
      if ( szFullComment == null )
         ...
         sb_szFullComment = new StringBuilder( szFullComment );
            ZeidonStringConcat( sb_szFullComment, 1, 0, " mTempl.", 1, 0, 301 );
      szFullComment = sb_szFullComment.toString( );}
       {StringBuilder sb_szFullComment;
      if ( szFullComment == null )
         sb_szFullComment = new StringBuilder( 32 );
   ...
   { 
      ...
      if ( szFullComment == null )
         ...
         sb_szFullComment = new StringBuilder( szFullComment );
            ZeidonStringCopy( sb_szFullComment, 1, 0, "Nothing to accept mTempl.", 1, 0, 301 );
      szFullComment = sb_szFullComment.toString( );}
       {StringBuilder sb_szFullComment;
      if ( szFullComment == null )
         sb_szFullComment = new StringBuilder( 32 );
                                 ...
                                 String   szComment )
{
   ...
   { 
      ...
      if ( szFullComment == null )
         ...
         sb_szFullComment = new StringBuilder( szFullComment );
            ZeidonStringCopy( sb_szFullComment, 1, 0, "Cancel mTempl.", 1, 0, 301 );
      szFullComment = sb_szFullComment.toString( );}
       {StringBuilder sb_szFullComment;
      if ( szFullComment == null )
         sb_szFullComment = new StringBuilder( 32 );
   ...
   { 
      ...
      if ( szFullComment == null )
         ...
         sb_szFullComment = new StringBuilder( szFullComment );
            ZeidonStringCopy( sb_szFullComment, 1, 0, "Nothing to cancel mTempl.", 1, 0, 301 );
      szFullComment = sb_szFullComment.toString( );}
       {StringBuilder sb_szFullComment;
      if ( szFullComment == null )
         sb_szFullComment = new StringBuilder( 32 );
