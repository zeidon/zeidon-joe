...
ProcessUserLogin( View     ViewToWindow )
{
   ...
   //:// Note that Activate always returns at least an empty view.
   //:szLoginName = wWebXfer.Root.AttemptLoginName  // e.g. Lonza
   ...
   //:IF wWebXfer.Root.AttemptUserName = "Admin"
   ...
   { 
      ...
      { 
         ...
         //:nRC = 1  // not going to normal window
         nRC = 1;
      ...
      { 
         ...
         lTempInteger_6 = CheckExistenceOfEntity( qOrganiz, "PrimaryRegistrant" );
         if ( lTempInteger_6 == 0 )
         { 
            //:IF qOrganiz.Subregistrant EXISTS
            lTempInteger_7 = CheckExistenceOfEntity( qOrganiz, "Subregistrant" );
            if ( lTempInteger_7 == 0 )
            { 
               //:wWebXfer.Root.KeyRole = "D"
         ...
         { 
            //:IF qOrganiz.Subregistrant EXISTS
            lTempInteger_8 = CheckExistenceOfEntity( qOrganiz, "Subregistrant" );
            if ( lTempInteger_8 == 0 )
            { 
               //:wWebXfer.Root.KeyRole = "S"  // for now
   ...
   { 
      ...
      lTempInteger_9 = SetEntityCursor( qOrganiz, "User", "UserName", lControl, szUserName, "", "", 0, "", "" );
      if ( lTempInteger_9 < zCURSOR_SET )
      { 
   ...
   {MutableInt mi_lTempInteger_10 = new MutableInt( lTempInteger_10 );
       GetIntegerFromAttribute( mi_lTempInteger_10, qOrganiz, "Organization", "ID" );
   lTempInteger_10 = mi_lTempInteger_10.intValue( );}
   o_fnLocalBuildQual_3( ViewToWindow, vTempViewVar_2, lTempInteger_10 );
   ...
   { 
      ...
      { 
         ...
         if ( szLoginName == null )
            ...
            sb_szLoginName = new StringBuilder( szLoginName );
                   GetVariableFromAttribute( sb_szLoginName, mi_lTempInteger_11, 'S', 51, wWebXfer, "Root", "LoginName", "", 0 );
...
ProductManagement( View     ViewToWindow )
{
   ...
   { 
      ...
      //:ELSE  // IF wWebXfer.Root.KeyRole = "S"
   } 
   else
   { 
      ...
      //:SetWindowActionBehavior( ViewToWindow, zWAB_StartTopWindow,
      //:                         "wSLC", "ListSubregProducts" )
      m_ZDRVROPR.SetWindowActionBehavior( ViewToWindow, zWAB_StartTopWindow, "wSLC", "ListSubregProducts" );
...
PrimaryRegistrantCompanySetup( View     ViewToWindow )
{
   ...
   //:IF qOrganiz.PrimaryRegistrant EXISTS AND szKeyRole != "S"
   ...
   { 
      //:IF qOrganiz.Subregistrant EXISTS AND szKeyRole != "P"
...
ChangeUserPassword( View     ViewToWindow )
{
   ...
   //:mCurrentUser.User.AttemptPassword = ""
   SetAttributeFromString( mCurrentUser, "User", "AttemptPassword", "" );
   //:wWebXfer.Root.AttemptPassword = ""
   SetAttributeFromString( wWebXfer, "Root", "AttemptPassword", "" );
   //:wWebXfer.Root.ConfirmPassword = ""
   SetAttributeFromString( wWebXfer, "Root", "ConfirmPassword", "" );
...
ProcessAdministratorLogin( View     ViewToWindow )
{
   ...
   //:wWebXfer.Root.CurrentPassword = ""
   SetAttributeFromString( wWebXfer, "Root", "CurrentPassword", "" );
   //:wWebXfer.Root.KeyRole = "U"  // should already be set
   SetAttributeFromString( wWebXfer, "Root", "KeyRole", "U" );
...
LoadCommitForTestPurposes( View     ViewToWindow )
{
   ...
   //:ActivateOI_FromFile( mTempl, "mTempl", ViewToWindow,
   //:                     "c:\lplr\ePamms\bin\mTempl1.por", zIGNORE_ERRORS )
   ActivateOI_FromFile( mTempl, "mTempl", ViewToWindow, "c:\\lplr\\ePamms\\bin\\mTempl1.por", zIGNORE_ERRORS );
   //:SetNameForView( mTempl, "mTempl", 0, zLEVEL_TASK )
   ...
   ActivateOI_FromFile( mEPA, "mEPA", ViewToWindow, "c:\\lplr\\ePamms\\bin\\mEPA.por", zIGNORE_ERRORS );
   ...
   ActivateOI_FromFile( mPrimReg, "mPrimReg", ViewToWindow, "c:\\lplr\\ePamms\\bin\\mPrimReg.por", zIGNORE_ERRORS );
   ...
   ActivateOI_FromFile( mMasProd, "mMasProd", ViewToWindow, "c:\\lplr\\ePamms\\bin\\mMasProd.por", zIGNORE_ERRORS );
   ...
   ActivateOI_FromFile( mMasLC, "mMasLC", ViewToWindow, "c:\\lplr\\ePamms\\bin\\mMasLC.por", zIGNORE_ERRORS );
